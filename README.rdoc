...
You can output the embedded plist showing build environment details for a specific fsevent_watch via:
...
This should contain details such as:
    ...
    <string>2012-12-31T12:25:03-05:00</string>
    <key>FSEWVersionInfoBuilder</key>
    <string>travistilley</string>
    <key>FSEWCC</key>
    <string>/usr/local/bin/clang</string>
    <key>FSEWCFLAGS</key>
    <string>-fconstant-cfstrings -fstrict-aliasing -funroll-loops -mmacosx-version-min=10.6 -O3</string>
